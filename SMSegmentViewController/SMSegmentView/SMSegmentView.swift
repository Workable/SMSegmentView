...
open class SMSegmentView: UIControl {
    ...
    open var selectedSegmentIndex: Int {
        get {
            if let segment = self.selectedSegment {
                ...
                return UISegmentedControl.UISegmentedControlNoSegment
            }
        }
        set(newIndex) {
    ...
    open var stackMode: SMSegmentStackMode = .horizontal {
        didSet {
    ...
    open func add(_ segment: SMSegment) {
    ...
    open func removeSegmentAtIndex(_ index: Int) {
        ...
        if index == self.selectedSegmentIndex {
            self.selectedSegmentIndex = UISegmentedControl.UISegmentedControlNoSegment
        }
        self.resetSegmentIndicesWithIndex(index, by: -1)
